...
namespace Receipts_Server.Migrations
{
    ...
    [Migration("20211220172617_add_tariff_plan_entity")]
    partial class add_tariff_plan_entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.TariffPlan", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.Tariff", b =>
                {
                    b.HasOne("Models.Entities.Service", null)
                        .WithMany("Tariffs")
                        .HasForeignKey("ServiceId");
                });
